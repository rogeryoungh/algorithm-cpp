...
template <class NTT>
auto convolution_crt3(std::span<const u32> f, std::span<const u32> g, const u32 mod) {
  constexpr u32 P1 = 167772161, G1 = 3;
  constexpr u32 P2 = 469762049, G2 = 3;
  constexpr u32 P3 = 754974721, G3 = 11;
  constexpr Mont32 M1{P1}, M2{P2}, M3{P3};
  constexpr u32 ivm2 = M2.inv(M2.trans(P1));
  constexpr u32 ivm3 = M3.inv(M3.trans(P2));
  constexpr u32 ivm23 = M3.inv(M3.mul(M3.trans(P1), M3.trans(P2)));

  static NTT ntt1{M1, G1}, ntt2{M2, G2}, ntt3{M3, G3};
